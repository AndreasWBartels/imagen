...
/**
 * An <code>OperationDescriptor</code> describing the "SubtractConst"
 * operation.
 *
 * <p> The SubtractConst operation takes one rendered or renderable
 ...
 *
 * <p> By default, the destination image bounds, data type, and number
    ...
    protected boolean validateParameters(ParameterBlock args,
        ...
        if (length < 1) {
            message.append(getName() + " " +
                           JaiI18N.getString("SubtractConstDescriptor2"));
            return false;
        }
