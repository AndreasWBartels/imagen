 ...
 *
 * <p> The "Rotate" operation rotates an image about a given point by
 ...
 * default.
 *
 * <p> "Rotate" defines a PropertyGenerator that performs an
...
public class RotateDescriptor extends OperationDescriptorImpl {
     ...
     * specify the parameter list for the "Rotate" operation.
     */
    ...
    private static final String[] paramNames = {
        "xOrigin", "yOrigin", "angle", "interpolation", "backgroundValues"
    };

    /** The parameter class types for the "Rotate" operation. */
    private static final Class[] paramClasses = {
        java.lang.Float.class, java.lang.Float.class,
        java.lang.Float.class, org.eclipse.imagen.Interpolation.class,
	double[].class
    };
     ...
     * @param xOrigin The X origin to rotate about.
     * May be <code>null</code>.
     * @param yOrigin The Y origin to rotate about.
     * May be <code>null</code>.
