...
/**
 * An <code>OpImage</code> implementing the "Xor" operation as
 * described in <code>org.eclipse.imagen.operator.XorDescriptor</code>.
 *
 * <p>This <code>OpImage</code> logically "xors" the pixel values of two source
...
final class XorOpImage extends PointOpImage {
     ...
     */
    public XorOpImage(RenderedImage source1,
    ...
    /**
     * Xors the pixel values of two source images within a specified
     * rectangle.
     *
