 ...
 *
 * <p> The "MaxFilter" operation is a non-linear filter which is
...
public class MaxFilterDescriptor extends OperationDescriptorImpl {
    ...
    private static final String[][] resources = {
        ...
        {"DocURL",      "http://java.sun.com/products/java-media/jai/forDevelopers/jaiapi/org.eclipse.imagen.operator.MaxFilterDescriptor.html"},
    ...
    private static final Class[] paramClasses = {
        MaxFilterShape.class, java.lang.Integer.class
    };
     ...
     * @param maskShape The shape of the mask to be used for Max Filtering.
     * May be <code>null</code>.
     * @param maskSize The size (width/height) of the mask to be used in Max Filtering.
     * May be <code>null</code>.
    ...
    public static RenderedOp create(RenderedImage source0,
        ...
        ParameterBlockJAI pb =
            new ParameterBlockJAI("MaxFilter",
