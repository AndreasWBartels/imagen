...
public class SampleDescriptor extends OperationDescriptorImpl 
     ...
     * specify the parameter list for the "Sample" operation.
     */
...
class SampleOpImage extends PointOpImage {
    ...
    /**
     * Computes an area of a given byte-based destination Raster using a
     * souce RasterAccessor and a destination RasterAccesor.
    ...
    /**
     * Computes an area of a given int-based destination Raster using a
     * source RasterAccessor and a destination RasterAccesor.
     */
